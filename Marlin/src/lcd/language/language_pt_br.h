...
namespace Language_pt_br {
  ...
  PROGMEM Language_Str MSG_FILAMENT_SWAP_LENGTH            = _UxGT("Distância de Retração");
  ...
  PROGMEM Language_Str MSG_HEATING_FAILED_LCD_BED          = _UxGT("Aqueceimento mesa falhou");
  ...
  PROGMEM Language_Str MSG_MAZE                            = _UxGT("Maze");
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_INSERT        = _UxGT(MSG_3_LINE("Coloque filamento e", "pressione o botão", "para continuar..."));
